...
const ALBUMS = [
  {
    ...
    tracks: [
      { n: 1,  title: 'JESUS',                                              artist: 'Alexais' },
      { n: 2,  title: 'COUSINS',                                            artist: 'Alexais' },
      { n: 3,  title: 'KING OF SOUL (feat. FROMDABUNKER)',                  artist: 'CIATANNER' },
      { n: 4,  title: 'BABY I TRIED (feat. FROMDABUNKER & Sheffmade)',      artist: 'CIATANNER' },
      { n: 5,  title: 'WISH',                                               artist: 'Don Juan' },
      { n: 6,  title: 'MISSION CONTROL (feat. Text To Speech)',             artist: 'YZY Sam' },
      { n: 7,  title: 'BIANCA',                                             artist: 'YZY Sam' },
      { n: 8,  title: 'SISTERS AND BROTHERS',                               artist: 'YZY Sam' },
      { n: 9,  title: 'ALIVE (feat. Youngboy Never Broke Again & Playboi Carti)', artist: 'YZY Sam' },
      { n: 10, title: 'MAGAZINES',                                          artist: 'YZY Sam' },
      { n: 11, title: 'VIRGIL',                                             artist: 'YZY Sam' },
      { n: 12, title: 'SUNDAY',                                             artist: 'YZY Sam' },
      { n: 13, title: "BIANCAGOLD'S INTERLUDE",                             artist: 'YZYGOLD & BIANCAGOLD' },
      { n: 14, title: 'ALL THE LOVE',                                       artist: 'MAX3-16420999' },
    ],
  },
];
