...
const ALBUMS = [
   {
    ...
    tracks: [
      { n: 1,  title: 'NEVER ENDS',                            artist: 'MYBOIARTHUR & Buffet Westt', src: '' },
      { n: 2,  title: 'HENRY (feat. michaelem)',                        artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 3,  title: 'MYSTERY VAN',               artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 4,  title: 'STARS',           artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 5,  title: 'NUMBER ONE',        artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 6,  title: 'FAITH',                    artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 7,  title: 'WORRIED (feat. Enzo Arsy)',                      artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 8,  title: 'CASH COW',                artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 9,  title: 'STOP',                          artist: 'MYBOIARTHUR & Buffet West', src: '' },
      { n: 10, title: 'TOGETHER FOREVER',                         artist: 'MYBOIARTHUR & Buffet West', src: '' },
    ],
  },
  
  {
    ...
    tracks: [
      { n: 1,  title: 'FEEDER MAN',                            artist: 'Buffet West', src: '' },
      { n: 2,  title: 'BEAUTY AND THE FEAST',                        artist: 'Buffet West', src: '' },
      { n: 3,  title: 'FATTER (feat. Travis Scott)',               artist: 'Buffet West', src: '' },
      { n: 4,  title: 'ALL THE FOOD (feat. BTS)',           artist: 'Buffet West', src: '' },
      { n: 5,  title: 'LAST SNACK',        artist: 'Buffet West', src: '' },
      { n: 6,  title: 'BULKY',                    artist: 'Buffet West', src: '' },
      { n: 7,  title: 'HAM (feat. MilesYe)',                      artist: 'Buffet West', src: '' },
      { n: 8,  title: 'WHITE CASTLE',                artist: 'Buffet West', src: '' },
      { n: 9,  title: 'FRIES AND DOUGH',                          artist: 'Buffet West', src: '' },
      { n: 10, title: 'I CAN EAT',                         artist: 'Buffet West', src: '' },
      { n: 11, title: 'GEMINI SEASONING',                       artist: 'Buffet West', src: '' },
    ],
  },
