...
export const yzygoldConfig: ArtistConfig = {
  ...
  ALBUM_DESCRIPTIONS: {
    ...
    "NEVER STOP": "After becoming obsessed with Diddy's trial in early 2025, Ye began to regularly talk to Diddy and his family. What first sparked as an idea to executively produce an album on Diddy's behalf soon turned into a half-collaborative project with his son King Combs, featuring heavy involvement and curation from Ye. Preceded by an alternate version of the song \"LONELY ROADS\" and a brief mention during a livestream, NEVER STOP was surprise announced on June 26th and released at midnight.",
